...
Автоматическая предсказание тегов для товаров Lamoda на основе отзывов покупателей.
...
к компактному пулу ~20–30 эталонных тегов на категорию, при этом оставив возможность предсказывать 1–6 релевантных тегов для каждого отзыва.
Почему возможно - всего общих кластеров категорий 8, и их количество фиксировано. 
...
- Routing Lora слоев под категорию: при вызове указываем категорию — активируется соответствующий слой Lora.
